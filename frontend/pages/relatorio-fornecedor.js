            ...
            <tbody>
              <tr>
                <td className="col-3 py-3">
                  <strong>{"Fornecedor(a): ".toUpperCase()}</strong>
                  {resultado.fornecedor}
                </td>
                <td className="col-9 py-3" colSpan="3">
              ...
              <tr>
                <td colSpan={4} className="col-12 p-0 border-0">
                  <TabelaCustos
                    listaCustos={resultado.listaCustos}
                    totalCustos={totalCustos}
                  />
                </td>
              </tr>
              <tr>
                <td colSpan="3" className="col-9 pt-5 pb-1 fw-bold">
                  {"Valor total a pagar: ".toUpperCase()}
                </td>
                <td className="col-3 pt-5 pb-1">
                  {(totalProdutos - totalCustos).toLocaleString("pt-br", {
